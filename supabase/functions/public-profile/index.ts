...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (username === "demo") {
      ...
      const demoLinks = [
        { id: "00000000-0000-0000-0000-d00000000001", title: "OnlyFans", url: "https://onlyfans.com/alexmartin", icon: "link", position: 0, thumbnail_url: null, description: "Subscribe to my exclusive content 💋", bg_color: "#00AFF0", text_color: "#FFFFFF", style: "featured", section_title: null },
        { id: "00000000-0000-0000-0000-d00000000002", title: "Instagram", url: "https://instagram.com/alexmartin", icon: "link", position: 1, thumbnail_url: null, description: null, bg_color: "#E4405F", text_color: "#FFFFFF", style: "default", section_title: "Social media" },
        { id: "00000000-0000-0000-0000-d00000000003", title: "Twitter / X", url: "https://x.com/alexmartin", icon: "link", position: 2, thumbnail_url: null, description: null, bg_color: "#0F1419", text_color: "#FFFFFF", style: "default", section_title: "Social media" },
        { id: "00000000-0000-0000-0000-d00000000004", title: "YouTube", url: "https://youtube.com/@alexmartin", icon: "link", position: 3, thumbnail_url: null, description: "Watch my latest videos 🎬", bg_color: "#FF0000", text_color: "#FFFFFF", style: "default", section_title: "Content" },
        { id: "00000000-0000-0000-0000-d00000000005", title: "Newsletter", url: "https://newsletter.alexmartin.com", icon: "link", position: 4, thumbnail_url: null, description: null, bg_color: "#1A1A2E", text_color: "#FFFFFF", style: "default", section_title: "Content" },
      ];
      return new Response(
