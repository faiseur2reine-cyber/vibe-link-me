...
import { TapGrid as LayoutGrid, TapSparkles as Sparkles, TapEye as Eye, TapCheck as Check } from '@/components/icons/TapIcons';
import { Paintbrush, Type, Code, RotateCcw } from 'lucide-react';
