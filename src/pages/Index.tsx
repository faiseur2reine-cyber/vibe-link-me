  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="description" content="Créez votre page de liens en 30 secondes. Thèmes premium, analytics, deeplinks, age gate. Gratuit." />
        <meta property="og:title" content="MyTaptap — Le lien en bio pour créateurs" />
        <meta property="og:description" content="Créez votre page de liens en 30 secondes. Thèmes premium, analytics, deeplinks." />
