...
export const THEMES: Record<string, ThemeConfig> = {
  ...
  forest: {
    ...
    btn: 'bg-white/80 backdrop-blur-md text-emerald-900 rounded-2xl border border-emerald-200/40 shadow-[0_2px_12px_rgba(52,211,153,0.06)] hover:shadow-[0_8px_30px_rgba(52,211,153,0.12)] hover:bg-white/90 hover:-translate-y-[2px]',
    text: 'text-emerald-950',
    subtleText: 'text-emerald-500/50',
    ...
    avatarRing: 'ring-[3px] ring-white/80 shadow-[0_4px_24px_rgba(52,211,153,0.12)]',
    tier: 'starter',
  },
  neon: {
    name: 'Neon',
  ...
  glass_dark: {
    name: 'Glass Dark',
    bg: 'bg-gradient-to-b from-[#0f0f16] via-[#141420] to-[#0f0f16]',
    btn: 'bg-white/[0.05] backdrop-blur-2xl text-white/90 rounded-2xl border border-white/[0.06] shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] hover:bg-white/[0.09] hover:border-white/[0.12] hover:-translate-y-[2px]',
    text: 'text-white',
    subtleText: 'text-white/25',
    accent: 'text-sky-400',
    preview: 'bg-gradient-to-b from-gray-800 to-slate-900',
    cardBg: 'bg-white/[0.03] backdrop-blur-xl border border-white/[0.05]',
    avatarRing: 'ring-[3px] ring-white/8 shadow-[0_4px_30px_rgba(56,189,248,0.06)]',
    tier: 'starter',
  },
  pastel: {
    name: 'Pastel Dream',
  ...
  aurora: {
    ...
    btn: 'bg-white/[0.05] backdrop-blur-xl text-white/90 rounded-2xl border border-emerald-500/10 shadow-[0_2px_16px_rgba(52,211,153,0.04)] hover:bg-white/[0.09] hover:border-emerald-400/20 hover:shadow-[0_0_30px_rgba(52,211,153,0.08)] hover:-translate-y-[2px]',
    text: 'text-white',
    subtleText: 'text-emerald-200/25',
    accent: 'text-emerald-400',
    preview: 'bg-gradient-to-b from-violet-500 via-emerald-400 to-sky-400',
    cardBg: 'bg-white/[0.03] backdrop-blur-md border border-emerald-500/8',
    avatarRing: 'ring-[3px] ring-emerald-400/15 shadow-[0_4px_30px_rgba(52,211,153,0.08)]',
    tier: 'pro',
  },
  cyber: {
    name: 'Cyber',
  ...
  marble: {
    ...
    btn: 'bg-white text-stone-800 rounded-2xl border border-stone-200/50 shadow-[0_1px_4px_rgba(0,0,0,0.03),0_4px_16px_rgba(0,0,0,0.02)] hover:shadow-[0_4px_20px_rgba(0,0,0,0.06)] hover:border-stone-300/60 hover:-translate-y-[2px]',
    text: 'text-stone-800',
    subtleText: 'text-stone-400',
    accent: 'text-stone-700',
    preview: 'bg-gradient-to-b from-stone-200 to-stone-100',
    cardBg: 'bg-white/80 border border-stone-200/50',
    avatarRing: 'ring-[3px] ring-stone-200/60 shadow-[0_4px_24px_rgba(0,0,0,0.06)]',
    tier: 'free',
  },
  minimal: {
    name: 'Minimal',
